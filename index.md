  ...
  <section id="timeline">
    ...
    <article class="reveal">
      <div class="inner">
        <span class="date"></span>
        <h4>Q3 2021</h4>
        <p>Add liquidity to pools from <br>Stablecomp<br>Analytics section<br>Launchpad SCOMP<br>DAO formation (Governance)</p>
      </div>
    </article>
    <article class="reveal">
      <div class="inner">
        <span class="date"></span>
        <h4>Q4 2021</h4>
        <p>Launch Huobi HECO Chain<br>r/r Yield matrix on HECO<br>Mobile App</p>
      </div>
    </article>
    <article class="reveal">
      <div class="inner">
        <span class="date"></span>
        <h4>Q1 2022</h4>
        <p>Launch Crypto.org Chain<br>r/r yield matrix on Crypto.org</p>
      </div>
    </article>
    <article class="reveal">
      <div class="inner">
        <span class="date"></span>
        <h4>Q2 2022</h4>
        <p>Yield management section<br>VISA debit card</p>
      </div>
    </article>
  </section>
